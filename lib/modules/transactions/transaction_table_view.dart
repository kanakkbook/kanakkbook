...
import 'package:kanakk_book/modules/transactions/add_voucher.dart';
                ...
                child: Column(
                  children: [
                    ...
                    for (int i = 0; i < 20; i++)
                      Container(
                        width: 825,
                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(4),border: Border.all(color: Colors.grey[100]!)),
                        child: ExpansionTile(
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.end,
                  children: [
                     Text("Cr : ",style: Theme.of(context).textTheme.headlineSmall?.copyWith(color: Colors.black),),
                    Text("₹1000",style: Theme.of(context).textTheme.headlineSmall?.copyWith(color: Colors.green)),
                    Spacer(),
                    Text("Dr : ",style: Theme.of(context).textTheme.headlineSmall?.copyWith(color: Colors.black),),
                    Text("₹500",style: Theme.of(context).textTheme.headlineSmall?.copyWith(color: Colors.red)),
                    Spacer(),
                    Text("Total : ",style: Theme.of(context).textTheme.headlineSmall?.copyWith(color: Colors.black),),
                    Text(" +₹500",style: Theme.of(context).textTheme.headlineSmall?.copyWith(color: Colors.green)),
                  ],
                ),
              ),
            ),
